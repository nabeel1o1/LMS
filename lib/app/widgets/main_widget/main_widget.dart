...
class MainWidget {
          ...
          child: directionality(
            child: Container(
              ...
              decoration: BoxDecoration(
                  color: Colors.white, borderRadius: borderRadius(radius: 25)),
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        itemCount:
                            locator<AppLanguage>().appLanguagesData.length,
                        physics: const BouncingScrollPhysics(),
                        itemBuilder: (context, index) {
                          return GestureDetector(
                            onTap: () async {
                              await locator<AppLanguage>().saveLanguage(
                                  locator<AppLanguage>()
                                      .appLanguagesData[index]
                                      .code!
                                      .toLowerCase());
  ...
  static Widget navItem(PageNames thisPage, PageNames selectedPage, String name,
        ...
        child: Column(
          ...
          children: [
            ...
            AnimatedCrossFade(
              ...
              crossFadeState: thisPage == selectedPage
  ...
  static Widget homeNavItem(
      PageNames thisPage, PageNames selectedPage, Function onTap) {
    return SizedBox(
      width: getSize().width * .18,
      child: GestureDetector(
        onTap: () {
            ...
            Stack(
              children: [
                Center(
                  ...
                  colorFilter: ColorFilter.mode(green91(), BlendMode.srcIn),
                )),
                Positioned(
                    bottom: 4,
                    top: 0,
